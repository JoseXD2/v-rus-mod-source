...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("Appearance", [
			new DialogueLanguageOption("Change the language of the dialogue "),
	...
	*/
		...
		menuBG.animation.addByPrefix('idle', 'jiemianBackground', 12, true);
		menuBG.animation.play('idle');
		menuBG.setGraphicSize(Std.int(menuBG.width * 0.67));
